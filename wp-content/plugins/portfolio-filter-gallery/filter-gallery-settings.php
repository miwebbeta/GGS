...
<script>
	...
	<div class="row awp_bale_offer">
		<div class="">
			<h1><?php _e("Plugin's Bale Offer", PFG_TXTDM); ?></h1>
			<h3><?php _e('Get All Premium Plugin ( Personal Licence) in just $149', PFG_TXTDM); ?></h3>
			<h3><strike><?php _e('$399', PFG_TXTDM); ?></strike> <?php _e('For $149 Only', PFG_TXTDM); ?></h3>
		</div>
		<div class="">
			<a href="http://awplife.com/account/signup/all-premium-plugins" target="_blank" class="button button-primary button-hero load-customize hide-if-no-customize"><?php _e('BUY NOW', PFG_TXTDM); ?></a>
		</div>
	</div>
<hr>
<p class="">
	<h1><strong><?php _e('Try Our Other Free Plugins:', PFG_TXTDM); ?></strong></h1>
	<br>
	<a href="https://wordpress.org/plugins/new-grid-gallery/" target="_blank" class="button button-primary load-customize hide-if-no-customize"><?php _e('Grid Gallery', PFG_TXTDM); ?></a>
	<a href="https://wordpress.org/plugins/new-social-media-widget/" target="_blank" class="button button-primary load-customize hide-if-no-customize"><?php _e('Social Media', PFG_TXTDM); ?></a>
	<a href="https://wordpress.org/plugins/new-image-gallery/" target="_blank" class="button button-primary load-customize hide-if-no-customize"><?php _e('Image Gallery', PFG_TXTDM); ?></a>
	<a href="https://wordpress.org/plugins/new-photo-gallery/" target="_blank" class="button button-primary load-customize hide-if-no-customize"><?php _e('Photo Gallery', PFG_TXTDM); ?></a>
	<a href="https://wordpress.org/plugins/responsive-slider-gallery/" target="_blank" class="button button-primary load-customize hide-if-no-customize"><?php _e('Responsive Slider Gallery', PFG_TXTDM); ?></a>
	<a href="https://wordpress.org/plugins/new-contact-form-widget/" target="_blank" class="button button-primary load-customize hide-if-no-customize"><?php _e('Contact Form Widget', PFG_TXTDM); ?></a>
	<a href="https://wordpress.org/plugins/facebook-likebox-widget-and-shortcode/" target="_blank" class="button button-primary load-customize hide-if-no-customize"><?php _e('Facebook Likebox Plugin', PFG_TXTDM); ?></a>
	<a href="https://wordpress.org/plugins/slider-responsive-slideshow/" target="_blank" class="button button-primary load-customize hide-if-no-customize"><?php _e('Slider Responsive Slideshow', PFG_TXTDM); ?></a>
	<a href="https://wordpress.org/plugins/new-video-gallery/" target="_blank" class="button button-primary load-customize hide-if-no-customize"><?php _e('Video Gallery', PFG_TXTDM); ?></a><br><br>
	<a href="https://wordpress.org/plugins/new-facebook-like-share-follow-button/" target="_blank" class="button button-primary load-customize hide-if-no-customize"><?php _e('Facebook Like Share Follow Button', PFG_TXTDM); ?></a>
	<a href="https://wordpress.org/plugins/new-google-plus-badge/" target="_blank" class="button button-primary load-customize hide-if-no-customize"><?php _e('Google Plus Badge', PFG_TXTDM); ?></a>
	<a href="https://wordpress.org/plugins/media-slider/" target="_blank" class="button button-primary load-customize hide-if-no-customize"><?php _e('Media Slider', PFG_TXTDM); ?></a>
	<a href="https://wordpress.org/plugins/weather-effect/" target="_blank" class="button button-primary load-customize hide-if-no-customize"><?php _e('Weather Effect', PFG_TXTDM); ?></a>
</p>
