...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/it_IT/sdk.js#xfbml=1&version=v2.8&appId=152139244877831";
...
<div class="fb-like" data-href="https://www.facebook.com/svegliadesign/" data-layout="standard" data-action="like" data-size="small" data-show-faces="false" data-share="true"></div>
<div><?php
echo '<a href="https://www.paypal.me/svegliatbuttons" target="_blank"><img src="' . plugins_url( 'admin-images/caffe.png' , __FILE__ ) . '" ></a> ';
?>
</div>
...
<?php
echo '<img src="' . plugins_url( 'admin-images/button-editor.png' , __FILE__ ) . '" > ';
?>
...
<input id="myButton" type="button" class="button button-primary" value="Generate shortcode"/>
 <br /><br />
<textarea id="mostraCodice" name="codiceMostrato" cols="70" rows="3"></textarea>
 <br /><br />

</form> 
<div><a href="http://www.lastwebagency.com/about-us/" title="about us" target="_blank">About us</a> | <a href="http://www.svegliatemplate.com/" title="blog" target="_blank">Blog</a> | <a href="https://www.facebook.com/svegliadesign" title="Facebook" target="_blank">Facebook</a> | <a href="https://plus.google.com/+Svegliatemplate" title="Google+" target="_blank">Google+</a> | <a href="https://www.facebook.com/gdbs1/" title="GDBS">GDBS - Graphic Designers of the Baltic States</a> | </div>
    <?php
}
...
function my_register_tinymce_plugin($plugin_array) {
  $plugin_array['MY_mce_button'] = 
    get_bloginfo( 'url' ) . '/wp-content/plugins/svegliat-buttons/js/tinymcebut.js';
  return $plugin_array;
}
