...
/*
if ( ! function_exists('wpmm_fields_group_generator')){
    function wpmm_fields_group_generator($fields = array()){
        if (count($fields)){

            $html = "<form method='post' action='{$fields['form_action']}'>";
            $html .="<div id='{$fields['fields_group_id']}' class='{$fields['fields_group_id']}-wrap'>";

            $html .= "<div class='{$fields['fields_group_id']}-tabs-menu'>";

            $html .= "<ul>";
            foreach ($fields['sections'] as $skey => $svalue){
