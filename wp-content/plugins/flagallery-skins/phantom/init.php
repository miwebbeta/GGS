...
wp_enqueue_style('flagallery-phantom-skin', $skin_url . '/css/phantom.css', array('magnific-popup'), $ver);
wp_enqueue_script('flagallery-phantom-skin', $skin_url . '/js/phantom.js', array(
    'jquery',
    'magnific-popup',
), $ver, true
);
