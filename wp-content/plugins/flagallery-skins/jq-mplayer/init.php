...
wp_enqueue_style('flagallery-jq-mplayer-skin', $skin_url . '/css/jq-mplayer.css', array(), $ver);
wp_enqueue_script('flagallery-jq-mplayer-skin', $skin_url . '/js/jq-mplayer.js', array('jplayer'), $ver, true);
