...
wp_enqueue_style('flagallery-wp-videoplayer-skin', $skin_url . '/css/wp-videoplayer.css', array('mediaelement'));
wp_enqueue_script('flagallery-wp-videoplayer-skin', $skin_url . '/js/wp-videoplayer.js', array(
    'jquery',
    'wp-util',
    'backbone',
    'mediaelement',
