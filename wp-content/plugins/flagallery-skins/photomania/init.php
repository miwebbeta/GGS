...
wp_enqueue_style('flagallery-photomania-skin', $skin_url . '/css/photomania.css', array('swiper'), $ver);
wp_enqueue_script('flagallery-photomania-skin', $skin_url . '/js/photomania.js', array('jquery', 'swiper', 'mousetrap'), $ver, true);
